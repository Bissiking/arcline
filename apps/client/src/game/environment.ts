...
export const ENVIRONMENTS: readonly Environment[] = [
  {
    ...
    clouds: [
      ...
      { x: 1360, y: 110, scale: 0.9, alpha: 0.9 },
      { x: 1720, y: 200, scale: 0.55, alpha: 0.7 },
      { x: 2050, y: 120, scale: 0.8, alpha: 0.85 },
      { x: 2400, y: 180, scale: 0.6, alpha: 0.75 },
    ],
    mountains: [
      { x: 240, y: 640, w: 640, h: 170 },
      { x: 720, y: 640, w: 520, h: 130 },
      { x: 1500, y: 640, w: 700, h: 150 },
      { x: 2150, y: 640, w: 600, h: 120 },
    ],
    hillsFar: [
      { x: 160, y: 640, w: 780, h: 250 },
      { x: 700, y: 640, w: 900, h: 300 },
      { x: 1600, y: 640, w: 900, h: 280 },
      { x: 2200, y: 640, w: 700, h: 220 },
    ],
    hillsNear: [
      { x: -60, y: 640, w: 560, h: 200 },
      { x: 500, y: 640, w: 460, h: 150 },
      { x: 920, y: 640, w: 720, h: 230 },
      { x: 1450, y: 640, w: 600, h: 170 },
      { x: 2050, y: 640, w: 800, h: 210 },
    ],
    ground: {
      top: "#93c265",
      surface: "#7aa94e",
  ...
  },
  {
    ...
    clouds: [
      ...
      { x: 1400, y: 110, scale: 0.9, alpha: 0.5 },
      { x: 1900, y: 180, scale: 0.65, alpha: 0.4 },
      { x: 2300, y: 120, scale: 0.8, alpha: 0.45 },
    ],
    mountains: [
      { x: 140, y: 640, w: 900, h: 300 },
      { x: 820, y: 640, w: 640, h: 240 },
      { x: 1600, y: 640, w: 800, h: 280 },
      { x: 2300, y: 640, w: 600, h: 220 },
    ],
    hillsFar: [
      { x: 200, y: 640, w: 1000, h: 340 },
      { x: 700, y: 640, w: 620, h: 280 },
      { x: 1500, y: 640, w: 900, h: 320 },
      { x: 2300, y: 640, w: 700, h: 260 },
    ],
    hillsNear: [
      { x: -80, y: 640, w: 600, h: 220 },
      { x: 520, y: 640, w: 480, h: 170 },
      { x: 980, y: 640, w: 700, h: 250 },
      { x: 1350, y: 640, w: 700, h: 200 },
      { x: 2050, y: 640, w: 800, h: 230 },
    ],
    ground: {
      top: "#b5794a",
      surface: "#95613a",
  ...
  },
  {
    ...
    clouds: [
      ...
      { x: 1300, y: 100, scale: 0.95, alpha: 0.85 },
      { x: 1750, y: 190, scale: 0.6, alpha: 0.7 },
      { x: 2150, y: 120, scale: 0.85, alpha: 0.9 },
    ],
    mountains: [
      { x: 480, y: 640, w: 1000, h: 280 },
      { x: 100, y: 640, w: 640, h: 210 },
      { x: 1500, y: 640, w: 900, h: 250 },
      { x: 2300, y: 640, w: 600, h: 190 },
    ],
    hillsFar: [
      { x: 100, y: 640, w: 720, h: 220 },
      { x: 640, y: 640, w: 860, h: 260 },
      { x: 1450, y: 640, w: 850, h: 240 },
      { x: 2250, y: 640, w: 700, h: 200 },
    ],
    hillsNear: [
      { x: -40, y: 640, w: 520, h: 180 },
      { x: 640, y: 640, w: 520, h: 160 },
      { x: 1300, y: 640, w: 600, h: 170 },
      { x: 2000, y: 640, w: 600, h: 150 },
    ],
    ground: {
      top: "#a7c66a",
      surface: "#7fad52",
